...
export class ApiKeyService {
    public static readonly createApiKey = async (user_id: string, api_key_name: string) => {
        console.log("hi")
    ...
    public static readonly updateApiKey = async (api_key_id: string, user_id: string) => {
